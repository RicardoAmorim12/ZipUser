...
import 'package:fastdelivery_multivendor/common/widgets/hover_widgets/text_hover_widget.dart';
      ...
      children: [
        ...
        Container(
          ...
          child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Row(children: [
            ...
            Row(
              children: [
                MenuButton(title: 'home2'.tr, onTap: () => Get.toNamed(RouteHelper.getInitialRoute())),
                const SizedBox(width: 20),
