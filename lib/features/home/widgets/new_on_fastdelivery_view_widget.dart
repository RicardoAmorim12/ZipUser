...
import 'package:fastdelivery_multivendor/features/home/widgets/restaurants_card_widget.dart';
...
class NewOnFastDeliveryViewWidget extends StatelessWidget {
  final bool isLatest;
  const NewOnFastDeliveryViewWidget({super.key, required this.isLatest});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ) : const RestaurantsCardShimmer(isNewOnFastDelivery: false),
             ],
            ),
