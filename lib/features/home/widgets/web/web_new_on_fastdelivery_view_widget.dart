...
class WebNewOnFastDeliveryViewWidget extends StatelessWidget {
  final bool isLatest;
  const WebNewOnFastDeliveryViewWidget({super.key, required this.isLatest});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ) : const RestaurantsCardShimmer(isNewOnFastDelivery: true),
            ],
          ),
